...
class MainMenuState : GameState
{
	...
	public override void Render(RenderingContext rc, GameTime gameTime)
	{
		...
		// TODO: Test drawing offscreen?  Or with weird coordinates?
		...
		for (var n = 0; n < segments; n++)
		{
			...
			var y2 = 0;
			rc.DrawLine(x1, y1, x2, y2, rc.Palette[0, 5, 0]);
		}
		...
		rc.DrawFilledRect(_bounds, fillColor);
		rc.DrawRect(_bounds, borderColor);

		rc.DrawCircle(290, 190, 24, rc.Palette[5, 4, 0]);
